...
const Course = ({course}) => {
    ...
    return (
        <div className="p-3 space-y-3 bg-[#FFF] w-80 rounded-lg">
            ...
            <div className="flex justify-between items-center">
                ...
                <h4 className='text-[#1c1b1b99] font-medium'>Credit : {course_time}hr</h4>
            </div>
            <button className='w-full py-2 rounded-lg text-white hover:bg-[#2f81edbb] bg-[#2F80ED]'>Select</button>
        </div>
    );
};
Course.propTypes = {
